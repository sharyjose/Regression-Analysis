...
print(summary(fit5)) # SEs for betahats are larger than in simple linear regressions
#            Estimate Std. Error t value Pr(>|t|)    
...
#calculate the VIF using vif() function from the "car" library
library(car)
vif(fit3)
vif(fit4)
vif(fit5)
